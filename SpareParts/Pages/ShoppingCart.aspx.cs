...
public partial class Pages_ShoppingCart : System.Web.UI.Page
{
    ...
    private void CreateShopTable(List<Cart> purchaseList, out double subTotal)
    {
        ...
        foreach (Cart cart in purchaseList)
        {
            ...
            //Create the 'Quality" dropdownlist
            ...
            TableCell b4 = new TableCell {Text="Rs. "+ (cart.Amount * product.Price) };
            ...
            //Adding total amount of item in cart to subtotal
    ...
    private void ddlAmount_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        CartModel model = new CartModel();
        model.UpdateQuality(cartId, quantity);
